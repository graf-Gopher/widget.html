!(function (t) {
    (t.snowfall = function (e, i) {
        function s(s, n, a, o, l) {
            ...
            var r = null;
            i.image ? ((r = t(document.createElement("img"))), (r[0].src = i.image)) : ((r = t(document.createElement("div"))), r.css({ background: i.flakeColor })),
                r
                    .attr({ class: "snowfall-flakes", id: "flake-" + this.id })
                    .css({ width: this.size, height: this.size, position: i.flakePosition, top: this.y, left: this.x, fontSize: 0, zIndex: i.flakeIndex }),
                t(e).get(0).tagName === t(document).get(0).tagName ? (t("body").append(r), (e = t("body"))) : t(e).append(r),
                ...
                (this.update = function () {
                    if (
                        ...
                        (this.x += S === !1 ? Math.cos(this.step) : S + Math.cos(this.step)),
                            ...
                            if (s + this.speed + this.size > this.target.height) {
                                ...
                                (this.speed = 1),
                                    ...
                                    parseInt(e) + 1 < this.target.width && void 0 == n[parseInt(e) + 1][parseInt(s) + 1]
                                        ...
                                        ? this.x--
                                        : ((t.fillStyle = "#fff"), t.fillRect(e, s, this.size, this.size), (n[parseInt(e)][parseInt(s)] = 1), this.reset());
                    }
            ...
            if (g.getContext && g.getContext("2d"))
                for (var m = [], x = t(i.collection), u = i.collectionHeight, r = 0; r < x.length; r++) {
                    var z = x[r].getBoundingClientRect(),
                        w = t("<canvas/>", { class: "snowfall-canvas" }),
                        v = [];
                    if (z.top - u > 0) {
                        t("body").append(w), w.css({ position: i.flakePosition, left: z.left + "px", top: z.top - u + "px" }).prop({ width: z.width, height: u });
                        for (var y = 0; y < z.width; y++) v[y] = [];
                        m.push({ element: w.get(0), x: z.left, y: z.top - u, width: z.width, height: u, colData: v });
                    }
                }
            else i.collection = !1;
        }
        for (
            ...
            (l = o.length), o.push(new s(h(f, p - f), h(0, d), h(100 * i.minSize, 100 * i.maxSize) / 100, h(i.minSpeed, i.maxSpeed), l));
